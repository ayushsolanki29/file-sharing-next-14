    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
        ...
        <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
          ...
          <a
            href="#"
            className="mt-8 block rounded-full border border-gray-600 bg-white px-12 py-3 text-center text-sm font-medium text-gray-600 hover:ring-1 hover:ring-gray-600 focus:outline-none focus:ring active:text-gray-500"
          >
            Free Plan Running
          </a>
        </div>
